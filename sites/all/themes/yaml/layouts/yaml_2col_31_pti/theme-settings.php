...
function phptemplate_settings($saved_settings) {
  ...
  $defaults = array(
    ...
    'yaml_layout_page_width_min' => '800px',
    'yaml_layout_page_width_max' => '800px',
    'yaml_layout_page_width_col1' => '200px',
  ...
  $form = _yaml_get_themesettings_form($saved_settings, $defaults, '31');
