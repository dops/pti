 ...
 */
function _yaml_1col_add_css($vars = array()) {
  ...
  drupal_add_css($base_theme_directory .'/css/screen/basemod_1col.css', 'theme');
...
function _yaml_1col_add_styles($vars = array()) {
  ...
  // Page settings
  $styles .= _yaml_get_css_themesettings('1');
  ...
  $styles_ie6 = _yaml_get_css_ie6_themesettings('1', $base_theme_directory);
  if (!empty($styles_ie6)) {
    $styles .= "<!--[if lte IE 6]>\n";
 ...
 */
function _yaml_1col_theme_settings_install($theme) {
