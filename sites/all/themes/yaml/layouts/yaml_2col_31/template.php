 ...
 */
function _yaml_2col_31_add_css($vars = array()) {
...
function _yaml_2col_31_add_styles($vars = array()) {
 ...
 */
function _yaml_2col_31_theme_settings_install($theme) {
  if (is_null(theme_get_setting('yaml_layout_page_width')) || theme_get_setting('yaml_layout_page_width_col3') !== 'auto') {
    ...
    // Upgrade 'yaml_2col_31' from 6.x-3.0.6.10 to 6.x-3.0.6.11.
