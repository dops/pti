...
function yaml_preprocess_page(&$vars) {
  ...
  if (theme_get_setting('yaml_layout_page_gfxborder')) {
    $vars['border_top'] = '<div class="border-top"><div class="edge-tl"> </div><div class="edge-tr"> </div></div>' . "\n";
    $vars['border_bottom'] = '<div class="border-bottom"><div class="edge-bl"> </div><div class="edge-br"> </div></div>' . "\n";
  }

  // Add dynamic sidebar switching classes to body.
